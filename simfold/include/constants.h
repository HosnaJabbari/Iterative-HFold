...
#define MAXSLEN         1000  // maximum of total sequence length. The maximum value that can be used without causing an overflow is 46340. // Hosna: November 16, 2015, changed value from 5000
